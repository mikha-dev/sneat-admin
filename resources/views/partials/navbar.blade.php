...
<nav
    class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme {{ $layout['type'] == Dcat\Admin\Enums\LayoutType::HORIZONTAL() ? '' : $layout['content_type'].' navbar-detached' }} "
    id="layout-navbar">
